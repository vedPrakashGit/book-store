                          ...
                          <div className="w-full flex justify-between items-center gap-3">
                            ...
                            {book.availability === true ? (
                              <button
                                ...
                                className="py-2 flex-1 border-amber-200 block mt-2 bg-amber-300 hover:bg-amber-400 hover:text-black outline-current"
                              >
                                Add to Cart
                              </button>
                            ) : (
                              <button
                                className="py-2 flex-1 text-gray-300 border-gray-600 bg-gray-600 hover:border-gray-600 block mt-2 outline-current cursor-not-allowed"
                                disabled
                              >
                                Not in Stock
                              </button>
